...
import com.sbd.service.ArticleManager;
...
public class ArticleController {
	...
	@ResponseBody
	public Object updateArticleById(@PathVariable("id") Long id, Article a){  
		log.info("update article by articleId:"+id);  
		Article article = articleManager.getArticleById(id);
		article.setArticle_title(a.getArticle_title());
	...
	@ResponseBody
	public Object deleteArticleById(@PathVariable("id") Long id){  
		log.info("delete article by articleId:"+id);  
